...
export default function Header() {
  return (
    <>
      {/* Franja superior fija: logo + links */}
      <div className="sticky top-0 z-50 border-b border-white/10 bg-azul-noche/90 px-6 py-3 backdrop-blur-md">
        <div className="mx-auto flex max-w-5xl items-center justify-between">
          <div className="flex items-center">
            <Image
              src="/econsur-logo-full.png"
              alt="EconSur Consultora"
              width={210}
              height={55}
              priority
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <GlobeIcon />
              <span className="hidden sm:inline">econsur.ar</span>
            </a>
            <a
      ...
      {/* Hero degradado */}
      <header className="relative overflow-hidden bg-gradient-azul px-6 pb-24 pt-14 text-white sm:pb-32 sm:pt-16">
        {/* Formas decorativas */}
