  ...
  return (
    <div className="mx-auto -mt-16 max-w-5xl px-6 pb-20 sm:-mt-24">
      ...
      <form
        ...
        className="glass-card animate-fade-in-up rounded-3xl p-5 shadow-card sm:p-7"
      >
        <div className="grid gap-5 sm:grid-cols-2">
          <div>
            ...
            <div className="input-group">
              ...
              />
              <span className="input-unit">pb</span>
            </div>
          </div>
        ...
        <div className="mt-5 flex flex-col items-center gap-3 sm:flex-row sm:justify-end">
        ...
        resultado && (
          <div className="mt-10">
            ...
            <WarningBanner
              ...
              ganadorFinal={
                resultado.promedio.pOficialismo >= 0.5 ? "oficialismo" : "oposicion"
              }
            />
          </div>
        )
